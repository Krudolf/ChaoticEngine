...
int main(){    
	...
	CESceneLight*			m_light3	= m_scene->createLight(t_lightIntensity, t_lightAtenuation, t_position3);
	CESceneLight*			m_light4	= m_scene->createLight(t_lightIntensity, t_lightAtenuation, t_position4);
	CESceneLight*			m_light5	= m_scene->createLight(t_lightIntensity, t_lightAtenuation, t_position5);
